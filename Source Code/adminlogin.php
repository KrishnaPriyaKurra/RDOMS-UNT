    ...
    <div class="container">
        ...
        <div class="Loginarea">
            <form id="loginform" method="post" action="adminsubmit.php">
                <label id="userlabel">Admin Username</label><br>
        ...
        <div class="ShowForget">
            ...
            <a href="managerlogin.php" id="forgot">manager Login</a>
            <a href="#" id="forgot">Forgot Password?</a>
        </div>
        <button class="login" type="submit" form="loginform">Admin Login</button>
        <button class="contact" href="#">Contact Us</button>
        <div class="notmem">
            <label id="notmem">Not a member?</label>
            <a href="signup.php" id="signup">Sign up here</a>
        </div>
    </div>
</body>
